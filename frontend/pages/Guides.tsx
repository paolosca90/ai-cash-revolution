  ...
  const guides = [
    {
      ...
      description: "Come iniziare con AI Cash R-evolution",
      difficulty: "Principiante",
      duration: "10 min",
      icon: Play,
      content: {
        overview: "Questa guida ti aiuterà a configurare e utilizzare AI Cash R-evolution per la prima volta.",
        steps: [
          {
    ...
    },
    {
      ...
      icon: Brain,
      content: {
        overview: "AI Cash R-evolution integra machine learning avanzato per migliorare continuamente le performance di trading.",
        steps: [
          {
    ...
    },
    {
      ...
      icon: TrendingUp,
      content: {
        overview: "AI Cash R-evolution offre diverse strategie ottimizzate per diversi stili di trading e condizioni di mercato.",
        steps: [
          {
            title: "Scalping",
    ...
    },
    {
      ...
      icon: AlertCircle,
      content: {
        overview: "Risolvi rapidamente i problemi più comuni che potresti incontrare durante l'utilizzo di AI Cash R-evolution.",
        steps: [
          {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Tutto quello che devi sapere per utilizzare al meglio AI Cash R-evolution</p>
      </div>
