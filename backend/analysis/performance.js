...
export const getPerformance = api({
    expose: true,
    method: "GET",
...
export const getDetailedPerformance = api({
    expose: true,
    method: "GET",
    ...
    `;
    const mapToPerformanceStats = (rows) => {
        return rows.map(row => {
...
export const getPerformanceBySymbol = api({
    expose: true,
    method: "GET",
...
export const getPerformanceByStrategy = api({
    expose: true,
    method: "GET",
