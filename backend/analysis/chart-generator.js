...
export async function generateChart(symbol, marketData, analysis) {
    try {
...
async function generateQuickChart(symbol, marketData, analysis) {
    try {
...
function generateTradingViewWidget(symbol, analysis) {
...
function convertSymbolForTradingView(symbol) {
    const symbolMap = {
...
export async function generateChartWithChartJS(symbol, marketData, analysis) {
