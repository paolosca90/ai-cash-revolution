...
export async function recordSignalAnalytics(data) {
    try {
...
export async function recordSignalPerformance(data) {
    try {
        await analysisDB.exec `
...
export async function getSignalAnalytics(timeframe = 'day') {
...
export async function updateSignalOutcome(tradeId, actualDirection, profitLoss) {
    try {
